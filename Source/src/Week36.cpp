...
void CScheduleContainer::Week36()
	...
	Laatikot_ma = 1;	Laatikot_ti = 3;	Laatikot_ke = 3;	Laatikot_to = 1;	Laatikot_pe = 1;
	
	
	TInt KloMa1[4] = { 10,15,12,0 };		TInt KloTi1[4] = { 8,15,10,0 };		TInt KloKe1[4] = { 8,15,10,0 };					TInt KloTo1[4] = { 10,15,12,0 };		TInt KloPe1[4] = { 10,15,12,0 };	
	Maanantai_laatikonvari[1] = Sininen;	Tiistai_laatikonvari[1] = Vihrea;	Keskiviikko_laatikonvari[1] = Keltainen;	Torstai_laatikonvari[1] = Oranssi;	Perjantai_laatikonvari[1] = Violetti;
	
	TInt KloMa2[4] = { 0,0  ,  0,0 };		TInt KloTi2[4] = { 10,15,12,0 };		TInt KloKe2[4] = { 10,15,12,0 };			TInt KloTo2[4] = { 0,0  ,  0,0 };		TInt KloPe2[4] = { 0,0  ,  0,0 };	
	Maanantai_laatikonvari[2] = KRgbWhite;	Tiistai_laatikonvari[2] = Keltainen;	Keskiviikko_laatikonvari[2] = Harmaa;		Torstai_laatikonvari[2] = KRgbWhite;	Perjantai_laatikonvari[2] = KRgbWhite;
	
	TInt KloMa3[4] = { 0,0  ,  0,0 };		TInt KloTi3[4] = { 12,15,14,0 };		TInt KloKe3[4] = { 12,15,14,0 };			TInt KloTo3[4] = { 0,0  ,  0,0 };		TInt KloPe3[4] = { 0,0  ,  0,0 };	
	Maanantai_laatikonvari[3] = KRgbWhite;	Tiistai_laatikonvari[3] = Oranssi;		Keskiviikko_laatikonvari[3] = Vihrea;	Torstai_laatikonvari[3] = KRgbWhite;	Perjantai_laatikonvari[3] = KRgbWhite;
	
	TInt KloMa4[4] = { 0,0  ,  0,0 };		TInt KloTi4[4] = { 0,0  ,  0,0 };		TInt KloKe4[4] = { 0,0  ,  0,0 };			TInt KloTo4[4] = { 0,0  ,  0,0 };		TInt KloPe4[4] = { 0,0  ,  0,0 };
	Maanantai_laatikonvari[4] = KRgbWhite;	Tiistai_laatikonvari[4] = KRgbWhite;	Keskiviikko_laatikonvari[4] = KRgbWhite;	Torstai_laatikonvari[4] = KRgbWhite;	Perjantai_laatikonvari[4] = KRgbWhite;		
