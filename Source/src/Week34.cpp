...
void CScheduleContainer::Week34()
	{
	
	Laatikot_ma = 1;
	
	//Laatikko 1
	Aloitus_h_maanantai[1] = 13           ;
	Aloitus_min_maanantai[1] = 00         ;
	Lopetus_h_maanantai[1] = 14           ;
...
resourceOffset = iCoeEnv->AddResourceFileL( _L( "C:\\private\\2002AA26\\week34.rsc" ));
