...
void CScheduleContainer::Week37()
	{
	
	resourceOffset = iCoeEnv->AddResourceFileL( _L( "C:\\private\\2002AA26\\week37.rsc" ));
	
	Laatikot_ma = 1;	Laatikot_ti = 4;	Laatikot_ke = 3;	Laatikot_to = 4;	Laatikot_pe = 2;
	
	
	TInt KloMa1[4] = { 12,15,14,0 };		TInt KloTi1[4] = { 8,15,10,0 };		TInt KloKe1[4] = { 8,15,10,0 };					TInt KloTo1[4] = { 8,15,10,0 };		TInt KloPe1[4] = { 8,15,10,0 };	
	Maanantai_laatikonvari[1] = Sininen;	Tiistai_laatikonvari[1] = Vihrea;	Keskiviikko_laatikonvari[1] = Keltainen;	Torstai_laatikonvari[1] = TummaKeltainen;	Perjantai_laatikonvari[1] = TummaOranssi;
	
	TInt KloMa2[4] = { 0,0  ,  0,0 };		TInt KloTi2[4] = { 10,15,12,0 };		TInt KloKe2[4] = { 10,15,12,0 };			TInt KloTo2[4] = { 10,15,12,0 };		TInt KloPe2[4] = { 10,15,12,0 };	
	Maanantai_laatikonvari[2] = KRgbWhite;	Tiistai_laatikonvari[2] = Violetti;	Keskiviikko_laatikonvari[2] = Harmaa;		Torstai_laatikonvari[2] = Oranssi;	Perjantai_laatikonvari[2] = Violetti;
	
	TInt KloMa3[4] = { 0,0  ,  0,0 };		TInt KloTi3[4] = { 12,15,14,0 };		TInt KloKe3[4] = { 12,15,14,0 };			TInt KloTo3[4] = { 12,15,14,0 };		TInt KloPe3[4] = { 0,0  ,  0,0 };	
	Maanantai_laatikonvari[3] = KRgbWhite;	Tiistai_laatikonvari[3] = Oranssi;		Keskiviikko_laatikonvari[3] = Vihrea;	Torstai_laatikonvari[3] = TummaVihrea;	Perjantai_laatikonvari[3] = KRgbWhite;
	
	TInt KloMa4[4] = { 0,0  ,  0,0 };		TInt KloTi4[4] = { 14,15,16,0 };		TInt KloKe4[4] = { 0,0  ,  0,0 };			TInt KloTo4[4] = { 14,15,16,0 };		TInt KloPe4[4] = { 0,0  ,  0,0 };
	Maanantai_laatikonvari[4] = KRgbWhite;	Tiistai_laatikonvari[4] = Punainen;	Keskiviikko_laatikonvari[4] = KRgbWhite;	Torstai_laatikonvari[4] = Punainen;	Perjantai_laatikonvari[4] = KRgbWhite;		
	
	TInt KloMa5[4] = { 0,0  ,  0,0 };		TInt KloTi5[4] = { 0,0  ,  0,0 };		TInt KloKe5[4] = { 0,0  ,  0,0 };			TInt KloTo5[4] = { 0,0  ,  0,0 };		TInt KloPe5[4] = { 0,0  ,  0,0 };	
	Maanantai_laatikonvari[5] = KRgbWhite;	Tiistai_laatikonvari[5] = KRgbWhite;	Keskiviikko_laatikonvari[5] = KRgbWhite;	Torstai_laatikonvari[5] = KRgbWhite;	Perjantai_laatikonvari[5] = KRgbWhite;	
	
	TInt KloMa6[4] = { 0,0  ,  0,0 };		TInt KloTi6[4] = { 0,0  ,  0,0 };		TInt KloKe6[4] = { 0,0  ,  0,0 };			TInt KloTo6[4] = { 0,0  ,  0,0 };		TInt KloPe6[4] = { 0,0  ,  0,0 };	
	Maanantai_laatikonvari[6] = KRgbWhite;	Tiistai_laatikonvari[6] = KRgbWhite;	Keskiviikko_laatikonvari[6] = KRgbWhite;	Torstai_laatikonvari[6] = KRgbWhite;	Perjantai_laatikonvari[6] = KRgbWhite;	
