...
void CScheduleContainer::Week38()
	{
	
	resourceOffset = iCoeEnv->AddResourceFileL( _L( "C:\\private\\2002AA26\\week38.rsc" ));
	...
	Maanantai_laatikonvari[1] = Harmaa;	Tiistai_laatikonvari[1] = Vihrea;	Keskiviikko_laatikonvari[1] = Keltainen;	Torstai_laatikonvari[1] = TummaKeltainen;	Perjantai_laatikonvari[1] = TummaOranssi;
