...
void CScheduleContainer::Week36()
	{
	
	Laatikot_ma = 1;
	
	//Laatikko 1
	   Aloitus_h_maanantai[1] =  10          ;
	 Aloitus_min_maanantai[1] =  15        ;
	   Lopetus_h_maanantai[1] =  12          ;
	 Lopetus_min_maanantai[1] =  00        ;
	Maanantai_laatikonvari[1] = KRgbBlue;
	
	//Laatikko 2
	   Aloitus_h_maanantai[2] =  0          ;
	 Aloitus_min_maanantai[2] =  0       ;
	   Lopetus_h_maanantai[2] =  0         ;
	 Lopetus_min_maanantai[2] =  0        ;
	Maanantai_laatikonvari[2] = KRgbGreen;

	//Laatikko 3
	   Aloitus_h_maanantai[3] =  0          ;
	 Aloitus_min_maanantai[3] =  0        ;
	   Lopetus_h_maanantai[3] =  0          ;
	 Lopetus_min_maanantai[3] =  0        ;
	Maanantai_laatikonvari[3] = KRgbRed;

	//Laatikko 4
	   Aloitus_h_maanantai[4] =  0          ;
	 Aloitus_min_maanantai[4] =  0        ;
	   Lopetus_h_maanantai[4] =  0          ;
	 Lopetus_min_maanantai[4] =  0        ;
	Maanantai_laatikonvari[4] = KRgbYellow;

	//Laatikko 5
	   Aloitus_h_maanantai[5] =  0          ;
	 Aloitus_min_maanantai[5] =  0        ;
	   Lopetus_h_maanantai[5] =  0          ;
	 Lopetus_min_maanantai[5] =  0        ;
	Maanantai_laatikonvari[5] = KRgbGray;

	//Laatikko 6
	   Aloitus_h_maanantai[6] =  0          ;
	 Aloitus_min_maanantai[6] =  0        ;
	   Lopetus_h_maanantai[6] =  0          ;
	...
	Maanantai_laatikonvari[6] = KRgbGreen;
		...
		//Laatikko 1
		 ...
		 Aloitus_min_tiistai[1] =  15        ;
		   Lopetus_h_tiistai[1] =  0         ;
		 Lopetus_min_tiistai[1] =  0        ;
		Tiistai_laatikonvari[1] = KRgbBlue;
		
		//Laatikko 2
		   Aloitus_h_tiistai[2] =  0          ;
		 Aloitus_min_tiistai[2] =  0        ;
		   Lopetus_h_tiistai[2] =  0         ;
		 Lopetus_min_tiistai[2] =  0        ;
		Tiistai_laatikonvari[2] = KRgbGreen;
	
		//Laatikko 3
		   Aloitus_h_tiistai[3] =  0          ;
		 Aloitus_min_tiistai[3] =  0        ;
		   Lopetus_h_tiistai[3] =  0          ;
		 Lopetus_min_tiistai[3] =  0        ;
		Tiistai_laatikonvari[3] = KRgbRed;
	
		//Laatikko 4
		   Aloitus_h_tiistai[4] =  0          ;
		 Aloitus_min_tiistai[4] =  0        ;
		   Lopetus_h_tiistai[4] =  0          ;
		 Lopetus_min_tiistai[4] =  0        ;
		Tiistai_laatikonvari[4] = KRgbYellow;
	
		//Laatikko 5
		   Aloitus_h_tiistai[5] =  0          ;
		 Aloitus_min_tiistai[5] =  0        ;
		   Lopetus_h_tiistai[5] =  0          ;
		 Lopetus_min_tiistai[5] =  0        ;
		Tiistai_laatikonvari[5] = KRgbGray;
	
		//Laatikko 6
		   Aloitus_h_tiistai[6] =  0          ;
		 Aloitus_min_tiistai[6] =  0        ;
		   Lopetus_h_tiistai[6] =  0          ;
		...
		Tiistai_laatikonvari[6] = KRgbGreen;	
			...
			//Laatikko 1
			   Aloitus_h_keskiviikko[1] = 10           ;
			 Aloitus_min_keskiviikko[1] = 15         ;
			   Lopetus_h_keskiviikko[1] = 12           ;
			 Lopetus_min_keskiviikko[1] = 00         ;
			Keskiviikko_laatikonvari[1] = KRgbGreen;
			
			//Laatikko 2
			   Aloitus_h_keskiviikko[2] = 0           ;
			 Aloitus_min_keskiviikko[2] = 0         ;
			   Lopetus_h_keskiviikko[2] = 0          ;
			 Lopetus_min_keskiviikko[2] = 0         ;
			Keskiviikko_laatikonvari[2] = KRgbGreen;
		
			//Laatikko 3
			   Aloitus_h_keskiviikko[3] = 0           ;
			 Aloitus_min_keskiviikko[3] = 0         ;
			   Lopetus_h_keskiviikko[3] = 0           ;
			 Lopetus_min_keskiviikko[3] = 0         ;
			Keskiviikko_laatikonvari[3] = KRgbRed;
		
			//Laatikko 4
			   Aloitus_h_keskiviikko[4] = 0           ;
			 Aloitus_min_keskiviikko[4] = 0         ;
			   Lopetus_h_keskiviikko[4] = 0           ;
			 Lopetus_min_keskiviikko[4] = 0         ;
			Keskiviikko_laatikonvari[4] = KRgbYellow;
		
			//Laatikko 5
			   Aloitus_h_keskiviikko[5] = 0           ;
			 Aloitus_min_keskiviikko[5] = 0         ;
			   Lopetus_h_keskiviikko[5] = 0           ;
			 Lopetus_min_keskiviikko[5] = 0         ;
			Keskiviikko_laatikonvari[5] = KRgbGray;
		
			//Laatikko 6
			   Aloitus_h_keskiviikko[6] = 0           ;
			 Aloitus_min_keskiviikko[6] = 0         ;
			   Lopetus_h_keskiviikko[6] = 0           ;
			...
			Keskiviikko_laatikonvari[6] = KRgbGreen;	
				...
				//Laatikko 1
				   Aloitus_h_torstai[1] = 0           ;
				 Aloitus_min_torstai[1] = 0         ;
				   Lopetus_h_torstai[1] = 0           ;
				 Lopetus_min_torstai[1] = 0         ;
				Torstai_laatikonvari[1] = KRgbBlue;
				
				//Laatikko 2
				   Aloitus_h_torstai[2] = 0           ;
				 Aloitus_min_torstai[2] = 0         ;
				   Lopetus_h_torstai[2] = 0          ;
				 Lopetus_min_torstai[2] = 0         ;
				Torstai_laatikonvari[2] = KRgbGreen;
			
				//Laatikko 3
				   Aloitus_h_torstai[3] = 0           ;
				 Aloitus_min_torstai[3] = 0         ;
				   Lopetus_h_torstai[3] = 0           ;
				 Lopetus_min_torstai[3] = 0         ;
				Torstai_laatikonvari[3] = KRgbRed;
			
				//Laatikko 4
				   Aloitus_h_torstai[4] = 0           ;
				 Aloitus_min_torstai[4] = 0         ;
				   Lopetus_h_torstai[4] = 0           ;
				 Lopetus_min_torstai[4] = 0         ;
				Torstai_laatikonvari[4] = KRgbYellow;
			
				//Laatikko 5
				   Aloitus_h_torstai[5] = 0           ;
				 Aloitus_min_torstai[5] = 0         ;
				   Lopetus_h_torstai[5] = 0           ;
				 Lopetus_min_torstai[5] = 0         ;
				Torstai_laatikonvari[5] = KRgbGray;
			
				//Laatikko 6
				   Aloitus_h_torstai[6] = 0           ;
				 Aloitus_min_torstai[6] = 0         ;
				   Lopetus_h_torstai[6] = 0          ;
				...
				//Laatikko 1
				   Aloitus_h_perjantai[1] = 10           ;
				 Aloitus_min_perjantai[1] = 15         ;
				   Lopetus_h_perjantai[1] = 12           ;
				 Lopetus_min_perjantai[1] = 00         ;
				Perjantai_laatikonvari[1] = KRgbRed;
				
				//Laatikko 2
				   Aloitus_h_perjantai[2] = 0           ;
				 Aloitus_min_perjantai[2] = 0         ;
				   Lopetus_h_perjantai[2] = 10          ;
				 Lopetus_min_perjantai[2] = 0         ;
				Perjantai_laatikonvari[2] = KRgbGreen;
			
				//Laatikko 3
				   Aloitus_h_perjantai[3] = 0           ;
				 Aloitus_min_perjantai[3] = 0         ;
				   Lopetus_h_perjantai[3] = 0           ;
				 Lopetus_min_perjantai[3] = 0         ;
				Perjantai_laatikonvari[3] = KRgbRed;
			
				//Laatikko 4
				   Aloitus_h_perjantai[4] = 0           ;
				 Aloitus_min_perjantai[4] = 0         ;
				   Lopetus_h_perjantai[4] = 0          ;
				 Lopetus_min_perjantai[4] = 0         ;
				Perjantai_laatikonvari[4] = KRgbYellow;
			
				//Laatikko 5
				   Aloitus_h_perjantai[5] = 0           ;
				 Aloitus_min_perjantai[5] = 0         ;
				   Lopetus_h_perjantai[5] = 0           ;
				 Lopetus_min_perjantai[5] = 0         ;
				Perjantai_laatikonvari[5] = KRgbGray;
			
				//Laatikko 6
				   Aloitus_h_perjantai[6] = 0           ;
				 Aloitus_min_perjantai[6] = 0         ;
				   Lopetus_h_perjantai[6] = 0           ;
...
resourceOffset = iCoeEnv->AddResourceFileL( _L( "C:\\private\\2002AA26\\week36.rsc" ));
